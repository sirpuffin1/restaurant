...
const Contact = () => {
    ...
    <img class="object-cover w-full h-96 rounded-t-lg md:h-auto md:w-48 md:rounded-none md:rounded-l-lg" src="https://rockandwings.rocks/wp-content/uploads/sites/9/2021/11/VideoCapture_20211127-150856.jpg" />
    <div class="flex flex-col justify-between p-4 leading-normal">
        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">2180 White Lane</h5>
        <ul>
        <li class="mb-3 font-normal text-gray-700 dark:text-gray-400"><a href="tel:6612825104">(661) 282-5104</a></li>
        <li class="mb-3 font-normal text-gray-700 dark:text-gray-400"><a href="mailto: rockandwings2017@yahoo.com">rockandwings2017@yahoo.com</a></li>
...
<div class="flex flex-col items-center bg-white rounded-lg border shadow-md md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
    <img class="object-cover w-full h-96 rounded-t-lg md:h-auto md:w-48 md:rounded-none md:rounded-l-lg" src="https://rockandwings.rocks/wp-content/uploads/sites/9/2021/11/20211116_124434-scaled.jpg" />
    <div class="flex flex-col justify-between p-4 leading-normal">
        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">2858 Niles Street</h5>
        <ul>
        <li class="mb-3 font-normal text-gray-700 dark:text-gray-400"><a href="tel:6614327743">(661) 432-7743</a></li>
        <li class="mb-3 font-normal text-gray-700 dark:text-gray-400"><a href="mailto: rockandwings2017@yahoo.com">rockandwings2017@yahoo.com</a></li>
